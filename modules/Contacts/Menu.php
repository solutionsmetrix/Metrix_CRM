...
if(empty($sugar_config['disc_client'])){
	if(ACLController::checkAccess('Contacts', 'list', true))$module_menu[] =Array("index.php?module=Reports&action=index&query=true&report_module=Contacts", $mod_strings['LNK_CONTACT_REPORTS'],"ContactReports", 'Contacts');
}
