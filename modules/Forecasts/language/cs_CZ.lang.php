...
$mod_strings = array (
  ...
  'LBL_BEST_CASE_BASE_CURRENCY' => 'Měna nejlepšího (upraveno)',
  'LBL_BEST_CASE_VALUE' => 'Nejlepší (upraveno)',
  'LBL_CANCEL' => 'Zrušit',
  'LBL_CHANGES_BY' => 'Změněno {0}',
  'LBL_CHART_ADJUSTED' => '(Upravena)',
  'LBL_CHART_AMOUNT' => 'Částka',
  'LBL_CHART_FOOTER' => 'Historie Prognóz',
  'LBL_CHART_FORECAST_FOR' => 'Předpověď pro {0}',
  ...
  'LBL_FORECASTS_CONFIG_ADMIN_SPLASH_2' => 'Tento průvodce vás krok po kroku provede nastavením modulu Předpovědi. Pro každou sekci jsou připravené výchozí hodnoty, takže budete moci brzo pokračovat!',
  'LBL_FORECASTS_CONFIG_ADMIN_SPLASH_3' => 'Můžete také provést manuální nastavení stisknutím',
  'LBL_FORECASTS_CONFIG_BREADCRUMB_RANGES' => 'Rozpětí',
  ...
  'LBL_FORECASTS_CONFIG_LEAFPERIOD' => 'Vyberte časový úsek, nad kterým chcete zobrazit vaše časové období:',
  'LBL_FORECASTS_CONFIG_PROJECTED_SCENARIOS' => 'Zobrazit navržené scénáře v sumářích',
  'LBL_FORECASTS_CONFIG_PROJECTED_SCENARIOS_BEST' => 'Zobrazit sumář nejlepšího případu',
  'LBL_FORECASTS_CONFIG_PROJECTED_SCENARIOS_LIKELY' => 'Zobrazit sumář pravděpodobného případu',
  'LBL_FORECASTS_CONFIG_PROJECTED_SCENARIOS_WORST' => 'Zobrazit sumář nejhoršího případu',
  'LBL_FORECASTS_CONFIG_RANGES' => 'Možnosti rozmezípředpovědi:',
  'LBL_FORECASTS_CONFIG_RANGES_EXCLUDE_INFO' => 'Všechny ostatní obchody budou vyřazeny.',
  'LBL_FORECASTS_CONFIG_RANGES_OPTIONS' => 'Nastavit výchozí rozpětí pravděpodobnosti pro obchody v předpovědi.',
  'LBL_FORECASTS_CONFIG_RANGES_SETUP_NOTICE' => 'Nastavení rozmezí nemůže být změněno po prvním uložení konceptu nebo potvrzení v modulu Předpovědí. Pro aktualizovanou instanci nicméně nemůže být nastavení rozmezí změněno po prvotní konfiguraci, protože data předpovědí jsou již disponibilní aktualizací.',
  'LBL_FORECASTS_CONFIG_SHOW_BINARY_RANGES_DESCRIPTION' => 'Obchody mohou být zařazeny nebo vyřazeny z předpovědi.',
  'LBL_FORECASTS_CONFIG_SHOW_BUCKETS_RANGES_DESCRIPTION' => 'Obchody mohou být v předpovědi označeny jako Zařazené, Perspektivní nebo Vyřazené. Perspektivní není ve výchozím stavu zařazen do předpovědí, ale umožňuje uživatelům dále klasifikovat vyřazené obchody na základě pravděpodobnosti uzavření.',
  'LBL_FORECASTS_CONFIG_SHOW_CUSTOM_BUCKETS_RANGES' => 'Vlastní rozmezí: Tato volba dává uživateli možnost kategorizovat jeho obchody, aby byly zařazeny do předpovědi do potvrzeného rozmezí vyřazeného rozmezí a jakýchkoliv jiných, které nastavíte.',
  ...
  'LBL_FORECASTS_CONFIG_TIMEPERIODS_BACKWARD' => 'Vyberte počet minulých časových období k zobrazení v listu.<br><i>Tento počet je aplikován na vybrané základní časové období. Například výběrem 2 měsíčích období se zobrazí předchozích 6 měsíců</i>',
  'LBL_FORECASTS_CONFIG_TIMEPERIODS_FORWARD' => 'Vyberte počet budoucích časových období k zobrazení v listu.<br><i>Tento počet je aplikován na vybrané základní časové období. Například výběrem 2 ročních budoucích období se zobrazí budoucích 8 čtvrtletí</i>',
  'LBL_FORECASTS_CONFIG_TIMEPERIOD_DESC' => 'Nastavte časová období použitá pro předpovědi.',
  'LBL_FORECASTS_CONFIG_TIMEPERIOD_SETUP_NOTICE' => 'Nastavení časového období nemůže být změněno po prvotním nastavení.',
  'LBL_FORECASTS_CONFIG_TIMEPERIOD_TYPE' => 'Vyberte typ roku, který vaše organizace používá pro účtování.',
  'LBL_FORECASTS_CONFIG_TITLE' => 'Nastavení prognóz',
  'LBL_FORECASTS_CONFIG_USER_SPLASH' => 'Předpovědi nebyly dosud nastaveny. Prosím kontaktujte vašeho systémového administrátora.',
  'LBL_FORECASTS_CONFIG_VARIABLES' => 'Proměnné',
  'LBL_FORECASTS_CONFIG_VARIABLES_CLOSED_LOST_STAGE' => 'Prosím vyberte fázi, která představuje uzavřené a ztracené obchody:',
  'LBL_FORECASTS_CONFIG_VARIABLES_CLOSED_WON_STAGE' => 'Prosím vyberte fázi, která představuje uzavřené a získané obchody:',
  'LBL_FORECASTS_CONFIG_VARIABLES_DESC' => 'Vzorce pro tabulku metrik závisí na fázi prodeje obchodů, které musí být vyřazeny ze zásobníku, například obchody, které jsou uzavřené a zatracené.',
  'LBL_FORECASTS_CONFIG_VARIABLES_FORMULA_DESC' => 'Proto bude vzorec pro pipeline :',
  'LBL_FORECASTS_CONFIG_WORKSHEET_LIKELY_INFO' => 'Pravděpodobný je založený na částce vložené v modulu Obchody',
  'LBL_FORECASTS_CONFIG_WORKSHEET_SCENARIOS' => 'Vyberte scénáře k zahrnutí do listu předpovědi.',
  ...
  'LBL_FORECAST_PIPELINE_OPP_COUNT' => 'Počet obchodů v zásobníku',
  ...
  'LBL_LIKELY_CASE_BASE_CURRENCY' => 'Měna pravděpodobného (upraveno)',
  'LBL_LIKELY_CASE_VALUE' => 'Pravděpodobné (upraveno)',
  'LBL_LIST_FORM_TITLE' => 'Závazná prognóza',
  'LBL_LOADING' => 'Nahrávání',
  'LBL_LOADING_COMMIT_HISTORY' => 'Načítání historie potvrzení..',
  ...
  'LBL_PIPELINE_OPPORTUNITIES' => 'Obchody zásobníku',
  'LBL_PIPELINE_REVENUE' => 'Obrat zásobníku',
  'LBL_PIPELINE_SIZE' => 'Velikost zásobníku',
  ...
  'LBL_UNAUTH_FORECASTS' => 'Neautorizovaný přístup do nastavení předpovědi.',
  'LBL_UP' => 'nahoru',
  ...
  'LBL_WORKSHEET_COMMIT_ALERT' => 'Potvrdili jste váš Rep. pohled, ale ne váš Manažerský pohled; Předpověď týmu nebude potvrzena,  dokud váš Manažerský pohled nebude potvrzený.',
  'LBL_WORKSHEET_COMMIT_CONFIRM' => 'Uložili jste změny, které nebyly potvrzeny v rep. pohledu. Uložené změny nebudou vidět v manažerském pohledu, dokud je nepotvrdíte. Stiskněte OK k potvrzení změn a pokračování nebo Storno k nepotvrzení změn a pokračování.',
  'LBL_WORKSHEET_EXPORT_CONFIRM' => 'Prosím berte na vědomí, že pouze uložená nebo potvrzená data mohou být exportována. Klikněte Ok pro export nebo Storno pro návrat do listu.',
  'LBL_WORKSHEET_ID' => 'Sešit ID',
  'LBL_WORKSHEET_SAVE_CONFIRM' => 'V listu jsou neuložené změny. Klikněte Ok k uložení těchto změn jako koncept a pokračování nebo Storno ke zrušení těchto změn a pokračování.',
  'LBL_WORKSHEET_SAVE_CONFIRM_UNLOAD' => 'Máte neuložené změny ve vašem listu.',
  'LBL_WORST_CASE' => 'Nejhorší případ:',
  'LBL_WORST_CASE_BASE_CURRENCY' => 'Měna nejhoršího (upraveno)',
  'LBL_WORST_CASE_VALUE' => 'Nejhorší (upraveno)',
  'LB_FS_BEST_CASE' => 'Nejlepší případ',
  'LB_FS_KEY' => 'ID',
  'LB_FS_LIKELY_CASE' => 'Pravděpodobný případ',
  'LB_FS_WORST_CASE' => 'Nejhorší případ',
  'LNK_FORECASTS_CONFIG_ADMIN_SPLASH_HERE' => 'zde.',
