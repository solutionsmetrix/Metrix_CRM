...
$mod_strings = array (
  ...
  'LBL_DASHLET_INCORRECT_URL' => 'E´ stata specificata una posizione errata del sito',
  ...
  'LBL_SOURCE_ADOBEFONTS' => 'Adobe Fonts - Fonts da Adobe Type Library.',
  ...
  'LBL_SOURCE_JEDITABLE' => 'jeditable - jQuery plugin che consente di modificare il contenuto di elementi html differenti.',
  ...
  'LBL_SOURCE_JSONJS' => 'JSON.js - Libreria progettata per lavorare con dati JSON in JavaScript.',
  'LBL_SOURCE_JSONPHP' => 'JSON.php - Fornisce una semplice strumento di codifica e decodifica per la notazione JSON.',
  ...
  'LBL_SOURCE_OVERLIB' => 'OverlibMWS - La libreria overlibmws utilizza javascript per popups DHTML che servono come aiuto informazionale e alla navigazione per siti web.',
  ...
  'LBL_SOURCE_PLACEHOLDER_BROKEN_URL' => '(In precedenza a questa url; l´url non è più disponibile.)',
  'LBL_SOURCE_PNGBEHAVIOR' => 'WebFX PNG Behavior - Fornisce supporto al formato PNG disponibile in Internet Explorer.',
  ...
  'LBL_SOURCE_XMLSECLIBS' => 'xmlseclibs - Una libreria scritta in PHP per lavorare con crittXML Encryption and Signatures.',
