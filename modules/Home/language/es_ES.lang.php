...
$mod_strings = array (
  ...
  'LBL_DASHLET_INCORRECT_URL' => 'Se ha indicado una localización incorrecta del sitio web',
  ...
  'LBL_SOURCE_ADOBEFONTS' => 'Fuentes Adobe - Fuentes de la Biblioteca de Tipos de Adobe.',
  ...
  'LBL_SOURCE_DATATABLE' => 'datatable - Plugin jQuery que añade controles avanzados de interacción a cualquier tabla HTML.',
  'LBL_SOURCE_ELASTICA' => 'Elastica - cliente PHP para el buscador distribuida elasticsearch',
  'LBL_SOURCE_ELEMENTREADY' => 'elementReady - Plugin jQuery para llamar a una función cuando un elemento está disponible, incluso antes de que el DOM está listo.',
  ...
  'LBL_SOURCE_HOVERINTENT' => 'hoverIntent - Plugin jQuery que intenta determinar la intención del usuario al over el ratón.',
  'LBL_SOURCE_HTMLPURIFIER' => 'Purificador HTML - Una biblioteca compatible con los estándares HTML de filtrado.',
  'LBL_SOURCE_HTMLSAFE' => 'HTML_Safe - Parser que elimina todo el contento potencialmente peligroso dentro de HTML.',
  ...
  'LBL_SOURCE_JEDITABLE' => 'jeditable - Plugin jQuery el cual permite editar contenido de diferentes elementos HTML.',
  ...
  'LBL_SOURCE_JQUERY_UI' => 'jQuery UI - jQuery UI es un conjunto de interacciones interface del usuario, efectos, widgets y temas construidos encima de la jQuery JavaScript Library.',
  ...
  'LBL_SOURCE_JSOLAIT' => 'Jsolait - Libreria JavaScript.',
  'LBL_SOURCE_JSONJS' => 'JSON.js - Librería diseñado para trabajar con los datos JSON en JavaScript.',
  'LBL_SOURCE_JSONPHP' => 'JSON.php - Proporciona un sencillo codificador y descodificador para las notaciones JSON.',
  'LBL_SOURCE_LESSPHP' => 'lessphp - A compilador de LESS escrito en PHP.',
  'LBL_SOURCE_LOG4PHP' => 'log4php - Una 	infraestructura versátil de registros para PHP.',
  ...
  'LBL_SOURCE_OAUTH2PHP' => 'oauth2-php - Una implementación de un servidor de OAuth 2.0 en PHP.',
  'LBL_SOURCE_OVERLIB' => 'OverlibMWS - la biblioteca OverlibMWS utiliza  javascript para crear popups en DHTML que sirven como ayudas de navegación e información para sitios web.',
  ...
  'LBL_SOURCE_PLACEHOLDER_BROKEN_URL' => '(Anteriormente disponible en este url; url ya no se encuentra disponible).',
  'LBL_SOURCE_PNGBEHAVIOR' => 'WebFX PNG Behavior - Añade soporte para el formato PNG disponible a Internet Explorer.',
  ...
  'LBL_SOURCE_SHOWLOADING' => 'showLoading - Plugin jQuery diseñado para mostrar un gráfico de carga en un área específica de la pantalla mientras que una petición ajax se está ejecutando.',
  'LBL_SOURCE_SINON' => 'sinon.js - Librerías de JavaScript para pruebas unitarias(stubs y mocks)',
  'LBL_SOURCE_SLIMSCROLL' => 'slimScroll - Plugin jQuery que transforma cualquier div en un área de desplazamiento con una estética barra de desplazamiento.',
  ...
  'LBL_SOURCE_SUPERFISH' => 'superFish - Plugin jQuery que añade mejoras en el uso de los menús desplegables de varios niveles.',
  ...
  'LBL_SOURCE_TIPTIP' => 'tiptip -  Un plugin inteligente de jQuery para ToolTip',
  'LBL_SOURCE_WICK' => 'Web Input Completion Kit - Framework para facilitar la entrada de texto en elementos de interfaces para utilizador en formularios, asistidos por fuentes de datos locales y remotas.',
  'LBL_SOURCE_XHPROF' => 'XHProf - un analizador jerárquico a nivel funcional para PHP',
  'LBL_SOURCE_XMLSECLIBS' => 'xmlseclibs - Una biblioteca escrita en PHP para trabajar con Codificación y Firmas XML.',
