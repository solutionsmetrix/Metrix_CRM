...
$mod_strings = array (
  ...
  'LBL_SOURCE_HOVERINTENT' => 'hoverIntent -Mouse hareketi ile kullanıcı amacını belirlemeye çalışan bir jQuery eklentisi.',
  ...
  'LBL_SOURCE_JQUERY_UI' => 'jQuery UI -  jQuery JavaScript Kütüphanesi üzerinde, kullanıcı arayüzü etkileşimleri, efektler, widget ve temalar için oluşturulmuş eklenti.',
  ...
  'LBL_SOURCE_OVERLIB' => 'OverlibMWS - Web sayfalarında bilgi ve navigasyon amacıyla kullanılan DHTML açılır pencereleri göstermek  için kullanılan overlibmws kütüphanesi javascript üzerinde çalışmaktadır.',
  ...
  'LBL_SOURCE_PLACEHOLDER_BROKEN_URL' => '(Bu url önceden kalma; url artık kullanılabilir değil.)',
  ...
  'LBL_SOURCE_SHOWLOADING' => 'showLoading - Ajax isteği çalışırken, ekranın belirli bir alanı üzerinde grafiksel bir yüklemeyi göstermesi için tasarlanan jQuery eklentisi.',
  'LBL_SOURCE_SINON' => 'sinon.js - Javascript test kütüphanesi.',
  'LBL_SOURCE_SLIMSCROLL' => 'slimScroll - Herhangi bir div alanını, güzel bir çubuk ile kaydırılabilir hale getiren jQuery eklentisi.',
  ...
  'LBL_SOURCE_SUPERFISH' => 'superFish - Çoklu-seviyeli-açılır liste menüleri için kullanılabiliği arttıran bir jQuery eklentisi.',
  ...
  'LBL_SOURCE_WICK' => 'Web Giriş Tamamlama Seti - Yerel ve uzaktan veri kaynakları tarafından desteklenecek şekilde, UI öğelerine metin girişini kolaylaştıran mimari.',
  'LBL_SOURCE_XHPROF' => 'XHProf - PHP için hiyerarşik profil aracı',
  'LBL_SOURCE_XMLSECLIBS' => 'xmlseclibs - XML şifreleme ve İmzalar ile çalışmak için PHP ile yazılmış bir kütüphane.',
