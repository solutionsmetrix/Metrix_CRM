...
$mod_strings = array (
  ...
  'ERR_MISSING_CREDENTIALS' => 'chyba: chybějící pověření',
  'ERR_MISSING_REQUIRED_FIELDS' => 'Chybí povinné pole',
  'ERR_MSG_FAILED' => 'Zpráva č. : {0} selhala. Důvod : Zpráva již byla importována',
  'ERR_NOT_ADDRESSED' => 'Email musí obsahovat adresu příjemce, v kopii nebo v přeposlat jinému adresátovi',
  'ERR_NO_IEID' => 'chyba: není ieID',
  'ERR_NO_UID' => 'chyba: není UID',
  'ERR_RCD_NUM_TO_DEL' => 'Pro smazání e-mailu musí být specifikováno číslo záznamu',
  ...
  'LBL_ID_MISMATCH' => 'NOOP: nesoulad ID',
  ...
  'LBL_MOVE_TO_BCC' => 'Přesunout do Bcc',
  ...
  'LBL_NOT_SUGAR_FOLDER' => 'NOOP - není složka Sugar',
  'LBL_NO_FOLDER_TYPE' => 'NOOP: nedefinován žádný folderType',
