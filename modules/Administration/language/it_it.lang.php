...
$mod_strings = array (
  ...
  'ERR_UW_NOT_ZIPPED' => 'Il file non è un archivio compresso',
  ...
  'LBL_ASYNC_CALL_FAILED' => 'Chiamata Asincrona Non Riuscita',
  ...
  'LBL_BROWSE' => 'Esplora',
  'LBL_BUG_DESC' => 'Mantieni un elenco delle release per il tuo prodotto. Le release attive sono visualizzate nel menù a tendina delle Release, nel bug records creato nel modulo Bugs.',
  ...
  'LBL_CONVERT_DISC_CLIENT_ADMIN_NAME_EMPTY' => 'Admin Name non può essere vuoto.',
  'LBL_CONVERT_DISC_CLIENT_CONFIG_WRITABLE_AGAIN_ERROR' => 'Scrittura sul file config.php fallita, si prega di renderlo scrivibile e riprovare (prima era scrivibile).',
  'LBL_CONVERT_DISC_CLIENT_CONFIG_WRITABLE_ERROR' => 'Si prega di rendere config.php scrivibile per continuare.',
  'LBL_CONVERT_DISC_CLIENT_DONE_LOGOUT' => 'Fatto - auto logout in <div id="seconds_left">10</div> secondi',
  'LBL_CONVERT_DISC_CLIENT_LOGIN_FAILED_ERROR' => 'Login fallito con errore:',
  'LBL_CONVERT_DISC_CLIENT_NO_LICENSE' => 'Licenze non disponibili per client offline',
  'LBL_CONVERT_DISC_CLIENT_PASSWORD_EMPTY_ERROR' => 'Password non può essere vuoto.',
  'LBL_CONVERT_DISC_CLIENT_SERVER_CLIENT_IP_ERROR' => 'Server e Client devo risiedere in macchine separate con un unico indirizzo IP',
  'LBL_CONVERT_DISC_CLIENT_SERVER_URL_EMPTY_ERROR' => 'Server URL non può essere vuoto.',
  'LBL_CONVERT_DISC_CLIENT_SERVER_URL_REQUIRED' => 'Server URL richiesto',
  'LBL_CONVERT_DISC_CLIENT_SUBMIT' => 'Cliccando Conferma, questa installazione sarà convertita in un client disconnesso. Ogni dato esistente andrà perso.',
  ...
  'LBL_CONVERT_DISC_CLIENT_SYNC_SUBMIT' => 'Cliccando Conferma sarai sincronizzato con il server principale.',
  'LBL_CONVERT_DISC_CLIENT_UNIQUE_SYSTEM_ID_ERROR' => 'Impossibile ottenere un unico ID di sistema dal server:',
  'LBL_CONVERT_DISC_CLIENT_UPDATE_LOCAL_INFO' => 'Aggiornamento Informazioni Locali',
  'LBL_CONVERT_DISC_CLIENT_USER_NAME_EMPTY_ERROR' => 'User Name non può essere vuoto.',
  ...
  'LBL_DENY' => 'Rifiuta',
  'LBL_DIAGNOSTICS_ERROR_LISTBEANFILES' => 'Impossibile scrivere sul file {0}beanFiles.html<br>',
  'LBL_DIAGNOSTICS_ERROR_MD5' => 'Impossibile copiare files.md5 su {0}<br>Saltare controlli md5.<br>',
  'LBL_DIAGNOSTICS_ERROR_PHPINFO' => 'Impossibile scrivere sul file {0}phpinfo.html<br>',
  ...
  'LBL_HISTORY_CONTACTS_EMAILS_DESC' => 'Abilita/Disabilita emails dei contatti nella cronologia',
  'LBL_HOURS' => 'Ore',
  'LBL_HT_DONE' => '--- FATTO ---',
  ...
  'LBL_IMPORT_CUSTOM_FIELDS_COUNT' => 'Totale Campi Personalizzati',
  ...
  'LBL_LDAP_GROUP_ATTR_REQ_DN' => 'Con User DN:',
  ...
  'LBL_OOTB_DCE_CLNUP' => 'Chiudi loop nelle azioni DCE completate',
  'LBL_OOTB_DCE_REPORT' => 'Crea azione per raccogliere i reports giornalieri',
  'LBL_OOTB_DCE_SALES_REPORT' => 'Crea Sales Report Email settimanali',
  ...
  'LBL_OOTB_SUGARFEEDS' => 'Pulisci Tabelle SugarFeed',
  ...
  'LBL_REBUILD_FULL_TEXT_ABORT' => 'Accesso non autorizzato. Interruzione.',
  ...
  'LBL_REMOVED_FILES' => 'Files rimossi',
  ...
  'LBL_REPAIR_UPLOAD_FOLDER' => 'Rimuovere i file mancanti dalla directory di upload',
  'LBL_REPAIR_UPLOAD_FOLDER_DESC' => 'Si prega di notare che la rimozione può impiegare molto tempo',
  ...
  'LBL_SELECT_FTS_MODULES_TITLE' => 'Clicca e trascina per selezionare i moduli da utilizzare nella Ricerca Globale. Clicca Salva per applicare le modifiche.',
  'LBL_SELECT_MODULES' => 'Avanzata',
  'LBL_SELECT_MODULES_TITLE' => 'Clicca e trascina per attivare e disattivare i moduli e modificare l´ordine di visualizzazione. Clicca Cerca per applicare le modifice.',
  ...
  'LBL_UPDATE_TIMEZONE_UPDATE' => 'Aggiornamento',
  'LBL_UPDATE_TIMEZONE_UPDATED' => 'Tutte le preferenze fuso orario aggiornate',
  ...
  'LBL_UPGRADE_FIELDS_SIMULATION_MODE' => 'MODALITA´ SIMULAZIONE - NON SARANNO APPORTATE MODIFICHE AD ECCEZIONE DELLA CANCELLAZIONE DELLA CACHE',
  ...
  'LBL_UPGRADE_WIZARD_FILE_NOT_SPEC' => 'File di installazione non specificato.',
