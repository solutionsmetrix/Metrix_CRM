...
$mod_strings = array (
  ...
  'LBL_BEST_CASE' => 'Най-добър сценарий',
  'LBL_BEST_CASE_BASE_CURRENCY' => 'Базова валута на най-добрия сценарий',
  'LBL_BEST_CASE_WORKSHEET' => 'Най-добър сценарий (коригиран)',
  ...
  'LBL_LIKELY_CASE_WORKSHEET' => 'Вероятен сценарий (коригиран)',
  ...
  'LBL_TYPE' => 'Категория:',
  'LBL_VIEW_FORM_TITLE' => 'Изглед на възможността',
  'LBL_WORKSHEET' => 'План',
  'LBL_WORST_CASE' => 'Най-лош сценарий',
