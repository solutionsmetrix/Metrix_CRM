...
if(empty($sugar_config['disc_client'])){
	if(ACLController::checkAccess('Leads', 'list', true))$module_menu[] =Array("index.php?module=Reports&action=index&query=true&report_module=Leads", $mod_strings['LNK_LEAD_REPORTS'],"LeadReports", 'Leads');
}
