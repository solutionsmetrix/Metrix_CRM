...
$mod_strings = array (
  ...
  'ERR_CHECKSYS_PCRE' => 'PCRE库未找到：SugarCRM的需要PCRE库，以便处理正则表达式模式匹配的Perl风格。',
  'ERR_CHECKSYS_PCRE_VER' => 'PCRE库版本：SugarCRM的需要PCRE库7.0或以上，来处理正则表达式模式匹配的Perl风格。',
