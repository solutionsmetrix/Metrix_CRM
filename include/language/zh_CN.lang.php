...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => '贵公司认购的SugarCRM的产品已过期，需要更新。只有管理员可以登录。如果您有任何疑问，请与管理员联系。',
  ...
  'LBL_CHOOSE_START_AND_END_DATES' => '请选择同时具有起始和结束日期范围',
  'LBL_CHOOSE_START_AND_END_ENTRIES' => '请同时选择开始和结束的项目范围',
  'LBL_CITY' => '城市',
  'LBL_CLEARALL' => '清除全部',
  ...
  'LBL_VCARD' => 'vCard',
  'LBL_VCARD_ERROR_DEFAULT' => '有一个错误上载的vCard文件。详情请参阅sugarcrm.log了解详情。',
  'LBL_VCARD_ERROR_FILESIZE' => '上传的文件超过在HTML表单中指定的30000字节大小限制。',
