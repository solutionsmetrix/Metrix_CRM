...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => 'Firmanızın SugarCRM Ürününe Üyeliğinin zamanı geçti ve yenilenmesi gerekiyor. Üyeliğin süresi dolduğunda yalnızda Sistem Yöneticileri bağlanabilir. Sorunuz varsa, lütfen yöneticiniz ile görüşünüz.',
  ...
  'ERR_MOBILE_INCOMPATIBLE_CLIENT_VERSION' => 'Uygulamanız versiyonu eski kalmış ve artık bağlandığınız {{{brandName}}} ile uyumlu değil. App Store&#39;dan yeni sürümü indirmek istiyor musunuz?',
  ...
  'LBL_CHOOSE_START_AND_END_DATES' => 'Lütfen başlangıç ve bitiş tarih aralığı seçin',
  'LBL_CHOOSE_START_AND_END_ENTRIES' => 'Lütfen başlangıç ve bitiş tarih aralığının her ikisini de seçin',
  'LBL_CITY' => 'Şehir',
  ...
  'LBL_EMPTY' => 'Boş',
  'LBL_EMPTY_REQUIRED_VCARD' => 'vCard Bu modül için  zorunlu alanların tamamını içermiyor. Ayrıntılar için sugarcrm.log bakın.',
  ...
  'LBL_PORTAL_MIN_MODULES' => 'Uygulamanın kullanılabilmesi için, En az Talepler, Hatalar veya Bilgi Bankası modüllerinin aktifleştirilmiş olması gerekir.',
  'LBL_PORTAL_NOT_ENABLED_MSG' => 'Üzgünüm, bu özellik şu anda mevcut değil.',
  'LBL_PORTAL_OFFLINE' => 'Maalesef Uygulamayı şu anda erişilebilir durumda değil. Lütfen sistem yöneticisi ile iletişime geçiniz.',
  ...
  'LBL_PORTAL_TOUR_SCREEN2_BODY' => '<p>Gösterge Panoları ana sayfanızı temsil eder. Bu şirketinizin Talepleri, Bilgi Bankası Makaleleri ve Hataların hızlı bir özetini görüntüler.</p> <p>Dashboard geri gezinmek için herhangi bir Portal sayfanın sol üst köşesinde Sugar küp simgesine tıklayın.</p> <p>Gösterge Panosu  en son değiştirilen beş kayıtı gösterir. Ek kayıtları görüntülemek için, modül bağlantısını tıklayın.</p>',
  ...
  'LBL_PORTAL_TOUR_SCREEN5_BODY' => '<p>Profil sayfasından, örneğin şifrenizi, e-posta adresinizi, tercih ettiğiniz dili değiştirebilirsiniz.</p>',
  'LBL_PORTAL_TOUR_SCREEN5_TITLE' => 'Profil',
  'LBL_PORTAL_TOUR_SCREEN6_BODY' => 'Her zaman tura geri dönebilir veya <a href="javascript:void window.open(&#39;http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/&#39;)">dokümanlar</a> adresinden daha fazla bilgi alabilirsiniz.',
  ...
  'LBL_TWITTER_ID_EMPTY' => 'Bu kayıt için  Twitter kulanıcı adı sağlanmadı.  @ deneyin',
  'LBL_TWITTER_TWEETS_BY' => 'Tweets Sahibi:',
  ...
  'LBL_VCARD' => 'vCard',
  'LBL_VCARD_ERROR_DEFAULT' => 'vCard dosyasının yüklenmesi sırasında hata oluştu. Lütfen detaylar için sugarcrm.log dosyasını kontrol ediniz.',
  'LBL_VCARD_ERROR_FILESIZE' => 'Yüklenen dosya, HTML formunda tanımlanan 30000 byte uzunluğunu aşıyor.',
