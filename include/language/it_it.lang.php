...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => 'La licenza della vostra azienda per SugarCRM è scaduta e dev´essere rinnovata. Solo l´amministratore può accedere. Per qualsiasi domanda si prega di contattare l´amministratore.',
  ...
  'ERR_EXTERNAL_API_NO_OAUTH_TOKEN' => 'Token OAuth di Accesso Mancante.',
  ...
  'ERR_MOBILE_FILE_PROCESSING' => 'Errore di elaborazione del file',
  'ERR_MOBILE_GENERIC_NATIVE_ERROR' => 'Si è verificato un errore inaspettato.',
  'ERR_MOBILE_INCOMPATIBLE_CLIENT_VERSION' => 'La tua app è obsoleta e non è più compatibile con l´istanza {{{brandName}}} a cui ti stai connettendo. Vuoi scaricare la nuova versione dall´App Store?',
  ...
  'ERR_MOBILE_UPLOAD' => 'Errore durante il caricamento del file',
  ...
  'LBL_ALT_SPOT_SEARCH' => 'Ricerca Spot',
  'LBL_AND' => 'E',
  ...
  'LBL_CHOOSE_START_AND_END_DATES' => 'Si prega di selezionare una data di inizio e una data di fine',
  'LBL_CHOOSE_START_AND_END_ENTRIES' => 'Si prega di selezionare sia l´intervallo di partenza che quello di fine delle voci.',
  'LBL_CITY' => 'Città',
  ...
  'LBL_COLLECTION_EXACT' => 'Specifico',
  ...
  'LBL_MOBILE_META_SYNC_FAILED_RETRY' => 'Impossibile effettuare la sincronizzazione con il server. Riprovare?',
  ...
  'LBL_MOBILE_PROCESSING_IMAGE' => 'Preparazione dell´immagine...',
  ...
  'LBL_MOBILE_TUTORIAL_HOME_END' => 'Godetevi tutte le nuove funzionalità!',
  ...
  'LBL_MOBILE_TUTORIAL_HOME_LOGO' => 'Menù di navigazione principale.',
  ...
  'LBL_MOBILE_TUTORIAL_PLUS_MENU_ACTIONS' => 'Selezionare l´azione specifica da veder eseguire',
  ...
  'LBL_MOBILE_UPLOAD_IN_PROGRESS' => 'Caricamento file...',
  ...
  'LBL_TOUR_FEATURES_670' => '<ul style=""><li class="icon-ok">Look & feel migliorati – ora con un nuovo tema moderno.</li><li class="icon-ok">Modulo Previsioni Migliorato – ora con un´interfaccia utente intuitiva e una nuova visualizzazione dei dati</li></ul>',
  ...
  'LBL_TOUR_SCREEN_3_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Selezionare l´Arco Temporale di analisi della previsione</li><li class="icon-ok">Visualizzare le matrici dei membri del tuo team di vendite e fornisci previsioni modificate</li><li class="icon-ok">Vedi gli avvisi sulle matrici quando un membro del team di vendita conferma una nuova previsione</li><li class="icon-ok">Salvare la matrice delle previsioni come bozza o confermare la previsione al tuo manager</li><li class="icon-ok">Visualizzare la cronologia delle tue pubblicazioni</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen3-thumb.png" width="220" id="thumbnail_3" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_3_TITLE_670' => 'Organizza le Vendite Previste del tuo Team Commerciale',
  'LBL_TOUR_SCREEN_4_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Visualizza il diagramma di Pareto per le analisi con pipeline attraverso tutte le previsioni del tuo team di vendite</li><li class="icon-ok">Scegli di visualizzare le vendite progettate per Probabilità della previsione, alla Migliore o alla Peggiore</li><li class="icon-ok">Visualizza le vendite progettate e quanto vicino sei al raggiungimento del budget del tuo team</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen4-thumb.png" width="220" id="thumbnail_4" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_4_TITLE_670' => 'Organizza le Vendite Previste del tuo Team Commerciale',
  'LBL_TOUR_SCREEN_5_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Selezionare l´Arco Temporale per la tua previsione</li><li class="icon-ok">Rivedere e modificare in-line importi e Probabilità di Vincita per una rapida analisi what-if</li><li class="icon-ok">Salvare la matrice delle previsioni come bozza o confermare la previsione al tuo manager </li><li class="icon-ok">Visualizzare la cronologia delle pubblicazioni precedenti</li><li class="icon-ok">Confermare la Previsione al tuo Manager e visualizzare la Cronologia delle pubblicazioni precedenti</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen5-thumb.png" width="220" id="thumbnail_5" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_5_TITLE_670' => 'Organizza le tue Vendite Previste',
  'LBL_TOUR_SCREEN_6_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Visualizzare il diagramma di Pareto per analisi pipeline rispetto al tempo per le tue Opportunità</li><li class="icon-ok">Scegli di visualizzare la distribuzione pipeline per Fase di Vendita o Probabilità di Vincita</li><li class="icon-ok">Visualizza le vendite progettate e quanto vicino sei al raggiungimento del budget a te assegnato</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen6-thumb.png" width="220" id="thumbnail_6" class="thumb"></div></div><div class="clear"></div>',
  ...
  'LBL_TWITTER_ID_EMPTY' => '',
  'LBL_TWITTER_TWEETS_BY' => '',
  ...
  'LBL_VCARD' => 'vCard',
  'LBL_VCARD_ERROR_DEFAULT' => 'Si è verificato un errore nel caricamento del file vCard. Si prega di fare riferimento a sugarcrm.log per i dettagli.',
  'LBL_VCARD_ERROR_FILESIZE' => 'Il file caricato supera la dimensione limite di 30000 bytes specificata nel form HTML.',
