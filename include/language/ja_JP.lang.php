...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => '貴社のSugerCRM製品のサブスクリプションは期限切れとなり更新が必要です。サブスクリプションが期限切れとなった時には管理者のみがログインできます。何かご質問があれば管理者に連絡してください。',
  ...
  'ERR_EXTERNAL_API_NO_OAUTH_TOKEN' => 'OAuth Accessトークンがありません。',
  ...
  'LBL_CHOOSE_START_AND_END_DATES' => '開始日と終了日の範囲の両方を選んでください。',
  'LBL_CHOOSE_START_AND_END_ENTRIES' => '開始と終了の範囲エントリーの両方を選んでください。',
  'LBL_CITY' => '市区町村',
  'LBL_CLEARALL' => 'すべてクリア',
  ...
  'LBL_TWITTER_ID_EMPTY' => 'このレコードにツイッターユーザ名が与えられていません。以下を試してください。',
  'LBL_TWITTER_TWEETS_BY' => '以下によるツイート',
  'LBL_TWO_WEEKS' => '二週後',
  ...
  'LBL_VCARD' => 'vCard',
  'LBL_VCARD_ERROR_DEFAULT' => 'vCardファイルのアップロードにエラーがありました。詳しくはsugarcrm.logを参照してください。',
  'LBL_VCARD_ERROR_FILESIZE' => 'アップロードされたファイルはHTMLフォームで指定されている30000バイトのリミットを超えています。',
