...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => 'Su Suscripción del producto SugarCRM ha vencido y debería ser renovado. Sólo el administrador puede entrar cuando la suscripción ha vencido.  Si tiene cualquier cuestión, por favor, contacte usted con su administrador.',
  ...
  'ERR_BAD_RESPONSE_FROM_SERVER' => 'Mala repuesta del servidor',
  ...
  'ERR_DATABSE_RELATIONSHIP_QUERY' => 'Error ajuste {0} relación: {1}',
  ...
  'ERR_EXTERNAL_API_NO_OAUTH_TOKEN' => 'Falta el OAuth token de acceso',
  ...
  'ERR_MOBILE_BROWSER_FORBIDDEN' => 'No permitido.',
  'ERR_MOBILE_BROWSER_INTERNAL_SERVER_ERROR' => 'Error en el servidor interno.',
  'ERR_MOBILE_BROWSER_NOT_AUTHORIZED' => 'Autenticación fallida',
  'ERR_MOBILE_BROWSER_PAGE_NOT_FOUND' => 'No se encuentra el recurso solicitado.',
  'ERR_MOBILE_BROWSER_SERVICE_UNAVAILABLE' => 'Servicio no disponible.',
  'ERR_MOBILE_CONNECTION_FAILED' => 'No se puede alcanzar el servidor.',
  'ERR_MOBILE_CONNECTION_FAILED_LOGIN' => 'Servidor no disponible con esta URL.',
  'ERR_MOBILE_EMAIL' => 'Error. Dirección de correo electrónico no válido.',
  'ERR_MOBILE_FILE_NOT_SUPPORTED' => 'Este tipo de documento no está apoyado.',
  'ERR_MOBILE_FILE_PROCESSING' => 'Error en el procesado del archivo',
  'ERR_MOBILE_GENERIC_NATIVE_ERROR' => 'Ha ocurrido un error.',
  'ERR_MOBILE_INCOMPATIBLE_CLIENT_VERSION' => 'La aplicación está anticuado y ya no es compatible con la instancia {{{brandName}}} en que está conectada. ¿Quiere bajar la nueva versión en la App Store?',
  'ERR_MOBILE_INTERNAL' => 'Error interno ({{{code}}}). Por favor, intente de nuevo más tarde.',
  'ERR_MOBILE_INTERNET_UNAVAILABLE' => 'Conexión a internet no disponible.',
  'ERR_MOBILE_INVALID_CREDS' => 'Usuario o contraseña no válido.',
  'ERR_MOBILE_NOT_AUTHORIZED' => 'Aceso no permitido.',
  'ERR_MOBILE_NOT_FOUND' => 'No se encuentra este recurso.',
  'ERR_MOBILE_NOT_FOUND_LOGIN' => 'No se encuentra el servidor {{{brandName}}} con esta URL.',
  'ERR_MOBILE_SESSION_EXPIRED' => 'Su sesión ha caducado.',
  'ERR_MOBILE_STORAGE_UNAVAILABLE' => 'La unidad de almacenamiento del dispositivo no está disponible',
  'ERR_MOBILE_TIMEOUT' => 'El servidor no responde.',
  'ERR_MOBILE_TIMEOUT_LOGIN' => 'Servidor no responde con esta URL.',
  'ERR_MOBILE_UPLOAD' => 'Ha producido un error mientras el archivo se subía',
  ...
  'ERR_PASSWORD_MISMATCH' => 'La contraseña introducida no coincide con la que el sistema tiene registrada.',
  ...
  'ERR_REENTER_PASSWORDS' => 'Las contraseñas deberían coincidir.',
  ...
  'ERR_SERVER_FLAVOR_INCOMPATIBLE' => 'Server flavor incompatible: {{{flavor}}}. Flavors apoyado: {{{supportedFlavors}}}.',
  'ERR_SERVER_VERSION_INCOMPATIBLE' => 'Versión de servidor incompatible: {{{version}}}. Versión mínima requirida: {{{minVersion}}}.',
  ...
  'ERR_SYNC_FAILED' => 'No se puede sincronizar con el servidor.',
  'ERR_TIMEPERIOD_ALREADY_HAS_LEAVES' => 'Este Periodo de Tiempo ya tiene sub-periodos',
  'ERR_TIMEPERIOD_ALREADY_LEAF' => 'Sub Periodos de Tiempo no pueden tener sub-periodos.',
  ...
  'LBL_ACTIVITY_VIEW_TOUR' => 'Tour de Vista de Actividades',
  'LBL_ADD' => 'Añadir',
  ...
  'LBL_ASSOC_EXISTING' => 'Vincular {{{this}}} Existente',
  ...
  'LBL_CHOOSE_LINK' => 'Elegir Tipo de Vinculación',
  'LBL_CHOOSE_MONTH' => 'Elegir mes',
  'LBL_CHOOSE_PARENT_TYPE' => 'Elegir Relacionado con',
  'LBL_CHOOSE_START_AND_END_DATES' => 'Por favor, elija tanto una fecha de comienzo como una de fin.',
  'LBL_CHOOSE_START_AND_END_ENTRIES' => 'Por favor elija entradas de rango de inicio y fin.',
  'LBL_CITY' => 'Ciudad',
  ...
  'LBL_CLICK_TO_DRILLDOWN' => 'Hacer click para examinar a fondo',
  ...
  'LBL_COLORS' => 'Colores',
  'LBL_COLUMNS_CAN_BE_DISPLAYED' => 'las columnas se pueden mostrar.',
  ...
  'LBL_CONFIRM_BUTTON_LABEL' => 'Aceptar',
  ...
  'LBL_CREATE_RELATED' => 'Crear {{{this}}} Relacionado/a',
  ...
  'LBL_EDIT_RELATED' => 'Editar {{{this}}} Relacionado/a',
  'LBL_EMAILS' => 'Correos',
  ...
  'LBL_EMPTY' => 'Vacío',
  'LBL_EMPTY_REQUIRED_VCARD' => 'vCard no tiene todos los campos requeridos para este módulo. Por favor, refiérase a sugarcrm.log para obtener más detalles.',
  ...
  'LBL_MAXIMUM_OF' => 'Límite Máximo de',
  ...
  'LBL_MOBILE_CHOOSE_DOC' => 'Elegir documento',
  'LBL_MOBILE_CHOOSE_LOCATION' => 'Elegir ubicación',
  'LBL_MOBILE_CHOOSE_PHONE' => 'Elegir número de teléfono',
  'LBL_MOBILE_CHOOSE_RECIPIENT' => 'Elegir destinatario',
  'LBL_MOBILE_CHOOSE_URL' => 'Elegir URL',
  ...
  'LBL_MOBILE_LOGING_OUT' => 'Por favor espere mientras cerramos la sesión...',
  'LBL_MOBILE_LOG_CALL_CONFIRM' => '¿Quiere registrar la última llamada?',
  'LBL_MOBILE_META_SYNC_FAILED' => 'No se puede sincronizar con el servidor.',
  'LBL_MOBILE_META_SYNC_FAILED_RETRY' => 'No se puede sincronizar con el servidor.  ¿Intentar de nuevo?',
  'LBL_MOBILE_NO_ACTIONS_AVAILABLE' => 'Ninguna acción disponible.',
  ...
  'LBL_MOBILE_RELOGIN_BUTTON' => 'Entrar de nuevo',
  ...
  'LBL_MOBILE_TUTORIAL_DETAIL_BACK' => 'Volver a la página anterior.',
  'LBL_MOBILE_TUTORIAL_DETAIL_CARD' => 'La información más important sobre un registro.',
  'LBL_MOBILE_TUTORIAL_DETAIL_INTRO' => 'Ésta es la página de detalles.',
  ...
  'LBL_MOBILE_TUTORIAL_HOME_END' => 'Disfruta de todas las nuevas funcionalidades!',
  'LBL_MOBILE_TUTORIAL_HOME_FAVORITES_BTN' => 'Filtrar la lista para que se vean mis registros favoritos.',
  'LBL_MOBILE_TUTORIAL_HOME_FAVORITES_ICON' => 'Marcar el registro como favorito.',
  'LBL_MOBILE_TUTORIAL_HOME_GRIP' => 'Acciones disponibles en un registro.',
  'LBL_MOBILE_TUTORIAL_HOME_INTRO' => 'Bienvenido a {{{brandName}}}.<br/><br/> Queremos enseñarte algunas funcionalidades nuevas.',
  'LBL_MOBILE_TUTORIAL_HOME_LOGO' => 'Navegación del menu principal.',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_DESKTOP' => 'Abrir Sugar en su navegador.',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_INTRO' => 'Éste es el menu de inicio.',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_LOGO' => 'Cerrar el menu de inicio',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_MODULES' => 'Ver módulo específico.',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_PROFILE' => 'Ver perfil.',
  'LBL_MOBILE_TUTORIAL_HOME_MENU_SETTINGS' => 'Personalizar la aplicación',
  'LBL_MOBILE_TUTORIAL_HOME_MY_ITEMS_BTN' => 'Filtrar la lista para que se vean los registros asignados a mi.',
  'LBL_MOBILE_TUTORIAL_HOME_RECENT' => 'Registros modificados recientemente.',
  'LBL_MOBILE_TUTORIAL_HOME_SEARCH' => 'Búsqueda global para registros.',
  'LBL_MOBILE_TUTORIAL_HOME_UPCOMING' => 'Mis eventos inminentes a partir de hoy.',
  'LBL_MOBILE_TUTORIAL_PLUS_MENU_ACTIONS' => 'Elegir la acción específica para ver para llevar a cabo.',
  'LBL_MOBILE_TUTORIAL_PLUS_MENU_CREATE' => 'Cerrar el menu plus.',
  'LBL_MOBILE_TUTORIAL_PLUS_MENU_INTRO' => 'Éste es el menu plus.',
  'LBL_MOBILE_UNLINK_CONFIRM' => '¿Está seguro que quiere desvincular este registro?',
  'LBL_MOBILE_UPLOAD_IN_PROGRESS' => 'Subiendo el archivo...',
  'LBL_MOBILE_UPLOAD_SUCCESS' => 'Archivo se ha subido con éxito.',
  ...
  'LBL_NO_ACCESS' => 'No tiene acceso a esta área.',
  ...
  'LBL_RELATED_MODULE' => '{{{this}}} Relacionado/a',
  'LBL_RELATED_MODULE_PLURAL' => '{{{this}}} Relacionado/a',
  ...
  'LBL_RESET_THEME_LNK' => 'Restaurar Tema Estándar',
  'LBL_RESET_THEME_MODAL_CONFIRM' => '¿Quiere continuar?',
  'LBL_RESET_THEME_MODAL_INFO' => 'Está a punto de reemplazar su tema personalizado por el tema estándar.',
  'LBL_RESET_THEME_MODAL_TITLE' => 'Restablecer tema estándar',
  'LBL_RESET_THEME_PROCESS' => 'Restaurando tema estándar...',
  ...
  'LBL_TOUR_FEATURES_670' => '<ul style=""><li class="icon-ok">Apariencia mejorada– ahora con un tema más moderno.</li><li class="icon-ok">Módulo de Previsión de Ventas Mejorado – ahora con un interfaz de usuario más intuitivo y visualización de nueva data</li></ul>',
  ...
  'LBL_TOUR_SCREEN_1_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Configurar tus parameters de previsión de ventas</li><li class="icon-ok">Hacer seguimiento fácilmente de las ventas previstas y la salud de tu pipeline</li><li class="icon-ok">Forecast basado en ventas previstas de tu equipo de ventas</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen1-thumb.png" width="220" id="thumbnail_1" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_1_TITLE_670' => 'Funcionalidad de previsión de ventas mejorada en Sugar',
  'LBL_TOUR_SCREEN_2_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Elegir la fecha de inicio del año fiscal</li><li class="icon-ok">Configurar los Periodos de Tiempo para que sean anuales o trimestrales</li><li class="icon-ok">Decidir cuántos Periodos de Tiempos, pasados o futuros, deberían ser visibles en la hoja de trabajo</li><li class="icon-ok">Seleccionar rangos de forecasts para etiquetar las Oportunidades como Incluir, Excluir, o Ventaja</li><li class="icon-ok">Seleccionar escenarios de forecast para que indiquen el escenario más Probable, Mejor y Peor. </li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen2-thumb.png" width="220" id="thumbnail_2" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_2_TITLE_670' => 'Configurar tus parameters de previsión de ventas',
  'LBL_TOUR_SCREEN_3_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Elegir el Periodo de Tiempo para revisar las previsiones de ventas</li><li class="icon-ok">Ver las hojas de trabajo de tu equipo de ventas y aportar forecasts ajustados</li><li class="icon-ok">Ver alertas en las hojas de trabajo cuando un miembro entrega una nueva forecast</li><li class="icon-ok">Guardar forecast como borrador y entregarlo a tu director</li><li class="icon-ok">Ver la historia de los commits anteriores</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen3-thumb.png" width="220" id="thumbnail_3" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_3_TITLE_670' => 'Gestionar las ventas previstas de tu Equipo de Ventas',
  'LBL_TOUR_SCREEN_4_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Ver diagrama de Pareto para el análisis del Pipeline a través de todas las previsiones de los miembros del equipo de ventas &#39;</li><li class="icon-ok">Seleccione para visualizar las ventas previstas por Probabilidad, Mejor o Peor previsión</li><li class="icon-ok">Ver las ventas previstas y lo pendiente para hacer su cuota de equipo</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen4-thumb.png" width="220" id="thumbnail_4" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_4_TITLE_670' => 'Gestionar las ventas previstas de tu Equipo de Ventas',
  'LBL_TOUR_SCREEN_5_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Elegir el Periodo de Tiempo para tus previsiones de ventas</li><li class="icon-ok">Revisar y editar cantidades sobre las líneas y probabilidades de cierre para un rápido análisis de posibles escenarios</li><li class="icon-ok">Guardar previsiones de venta en borrador o entregarlas a tu gerente</li><li class="icon-ok">Ver una historia de entregas anteriores</li><li class="icon-ok">Entregar las previsiones a tu gerente y ver una historia de entregas anteriores</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen5-thumb.png" width="220" id="thumbnail_5" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_5_TITLE_670' => 'Gestiona tus propias Ventas Previstas',
  'LBL_TOUR_SCREEN_6_DESCRIPTION_670' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Ver, con el paso de tiempo una gráfica Pareto para el análisis del pipeline para tus Oportunidades/li><li class="icon-ok">Elegir entre ver la distribución de tu pipeline por Fase de Venta o por Probabilidad de Ganar</li><li class="icon-ok">Ver la previsión de ventas y cuán cerca estás de alcanzar tu objetivo</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen6-thumb.png" width="220" id="thumbnail_6" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_6_TITLE_670' => 'Gestiona tus propias Ventas Previstas',
  ...
  'LBL_TRADEMARK' => 'SugarCRM es una marca registrada de SugarCRM, Inc.  Todas las compañías y nombres de productos pueden ser marcas registradas de las compañías respectivas a las cuales están asociadas.',
  ...
  'LBL_TWITTER_ID_EMPTY' => 'No se encuentra un usuario Twitter para este registro. Intenta @',
  'LBL_TWITTER_TWEETS_BY' => 'Tweets por',
  ...
  'LBL_VCARD' => 'vCard',
  'LBL_VCARD_ERROR_DEFAULT' => 'Ha habido un error al subir el archivo vCard.  Por favor, refiérase a sugarcrm.log para obtener más detalles.',
  'LBL_VCARD_ERROR_FILESIZE' => 'El archivo subido supera el límite de bytes de 30000 especificado en el HTML.',
  ...
  'MSG_JS_ALERT_MTG_REMINDER_RELATED_TO' => 'Relacionado con:',
  ...
  'SUGAR_API_EXCEPTION_NOT_AUTHORIZED' => 'No está permitido editar el campo {0} en el módulo: {1}',
  ...
  'UPLOAD_REQUEST_ERROR' => 'Ha ocurrido un error. Por favor refresque la página e intente de nuevo.',
  'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => '<b>Aviso:</b> Su navegador esta en vista compatibilidad IE, lo cual no está soportado.',
