...
$app_list_strings = array (
  ...
  array (
    'best' => 'Най-добър сценарии',
    'likely' => 'Вероятен сценарии',
    'worst' => 'Най-лош сценарии',
  ),
  ...
  array (
    ...
    'FAQ' => 'Често задавани въпроси',
    'Feeds' => 'RSS новини',
    'ForecastManagerWorksheets' => 'Прогнозни мениджърски планове',
...
$app_strings = array (
  ...
  'ERROR_LICENSE_FULLY_EXPIRED' => 'Лицензите за SugarCRM са с изтекла валидност и трябва да бъдат подновени. Само потребителите с администраторски права могат да се аутентикират в системата. Ако има въпроси, моля свържете се със системния администратор.',
  ...
  'LBL_ASSOC_RELATED_RECORD' => 'Свържете съшществуващ запис',
  'LBL_BACK' => 'Върни',
  ...
  'LBL_CHOOSE_START_AND_END_DATES' => 'Моля изберете начален и краен времеви период.',
  ...
  'LBL_COPYRIGHT' => 'Copyright © 2004-2013 SugarCRM Inc. Всички права запазени.',
  ...
  'LBL_EMPTY' => 'Empty',
  'LBL_EMPTY_REQUIRED_VCARD' => 'Електронната визитна картичка не съдържа всички задължителни полета за този модул. Моля прегледайте файла sugarcrm.log за повече информация.',
  ...
  'LBL_MOBILE_LOGING_OUT' => 'Моля изчакайте докато излизате от програмата...',
  ...
  'LBL_QUARTER_TIMEPERIOD_FORMAT' => 'Тримесечие{0} ({1} - {2})',
  ...
  'LBL_RESET_THEME_MODAL_CONFIRM' => 'Желаете ли да продължите?',
  'LBL_RESET_THEME_MODAL_INFO' => 'Ще изтриете създадената от вас тема и ще я замените с темата по подразбиране.',
  'LBL_RESET_THEME_MODAL_TITLE' => 'Зареждане на тема по подразбиране',
  ...
  'LBL_SEARCH_ALL_RECORDS' => 'Търси във всички записи',
  ...
  'LBL_TOUR_SCREEN_3_TITLE_670' => 'Управление на прогнозните продажби на вашия екип',
  ...
  'LBL_TOUR_SCREEN_4_TITLE_670' => 'Управление на прогнозните продажби на вашия екип',
  ...
  'LBL_TOUR_SCREEN_5_TITLE_670' => 'Управление на персоналнаните прогнозни продажби',
  ...
  'LBL_TRADEMARK' => 'SugarCRM е търговска марка на SugarCRM, Inc. Всички останали имена на компании и продукти могат да бъдат търговски марки на компании, с които са асоциирани.ch they are associated.',
  ...
  'LBL_VCARD_ERROR_DEFAULT' => 'Възникна грешка при качване електронната визитна картичка. Моля преглейдате файла sugarcrm.log за повече информация.',
  'LBL_VCARD_ERROR_FILESIZE' => 'Каченият файл надхвърля заложения лимит от 30000 байта.',
  ...
  'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => '<b>Предупреждение:</b> Вашият браузър е в режим IE compatibility view, който се поддържа.',
