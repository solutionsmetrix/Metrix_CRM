...
{DCMenu.qePanel=new YAHOO.widget.Panel('quickEditWindow',{width:"100%",draggable:true,close:true,constraintoviewport:true,fixedcenter:false,script:true,modal:true});}
