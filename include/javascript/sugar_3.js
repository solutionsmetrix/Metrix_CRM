...
{var Dom=YAHOO.util.Dom;var td=Dom.getAncestorByTagName(field,'TD');if(type=='date'&&!Dom.hasClass(td,'vis_action_hidden')){td=Dom.getAncestorByTagName(td,'TD');}
